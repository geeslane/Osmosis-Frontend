...
export default function WhatWeLookFor() {
  return (
    <div className="bg-green-200 w-full">
      <div className=" max-w-[1600px] mx-auto  h-full mt-20 text-white flex flex-col gap-8 font-montserrat montserrat w-full py-[60px] px-8 md:p-[60px] lg:p-[120px]">
          ...
          <div className="space-y-3 h-full">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base leading-8 md:text-xl">
                Minimum 5+ years of experience. You bring real-world insights
          ...
          <div className="space-y-3 h-full">
            ...
            <div className="space-y-2">
              ...
              <p className="text-base md:text-xl leading-8">
                Working with minors is a privilege. Mentors must pass a
                background check and adhere to our code of conduct.{' '}
              </p>
            </div>
          </div>
        </div>
