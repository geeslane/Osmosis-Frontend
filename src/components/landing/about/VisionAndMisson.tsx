    ...
    <div className="flex px-4 relative flex-col gap-14 w-full items-center mt-5 mb-20 overflow-x-hidden overflow-y-hidden pt-[10px] md:pt-[120px]">
      ...
      <div className="w-full  font-montserrat montserrat text-center items-center  flex flex-col justify-center gap-6 md:gap-8">
        ...
        <h3 className=" mb-3 text-center text-[#282F2E] text-lg md:text-2xl">
          Raising a generation of purpose-driven teens with inward confidence and clarity.
        </h3>
      </div>
      <div className="w-full max-w-[983px]  font-montserrat montserrat text-center items-center  flex flex-col justify-center gap-6 md:gap-8">
        ...
        <h3 className=" mb-3 text-[#282F2E] px-4 text-lg md:text-2xl">
          To empower teenagers to live a centered life, by building a nurturing ecosystem where
          teenagers discover their authentic identity, develop emotional and self-leadership skills, and
          harness the power of conscious choice through expert mentorship and transformative learning
          experiences.
        </h3>
      </div>
    </div>
