...
export default function HowItWorks() {
  return (
    <div className="w-full font-montserrat montserrat grid grid-cols-1 lg:grid-cols-3 gap-8 py-12 md:py-20 px-4 md:px-8 lg:px-16">
      ...
      <div className="md:ml-5 h-full flex flex-col justify-between ">
